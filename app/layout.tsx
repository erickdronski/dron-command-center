...
import {
  ...
  Calendar, FolderOpen, Brain, Users, Building2, Zap, CloudSun, BarChart2, Wrench, Rocket, Terminal
} from 'lucide-react';
...
const navItems = [
  ...
  { href: '/action-center', icon: Terminal, label: 'Action Center', highlight: true },
