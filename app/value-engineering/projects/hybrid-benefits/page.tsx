...
const hybridBenefits: HybridBenefit[] = [
  {
    ...
    rationale: 'The old environment valued incidents at $3.75/ticket — the new factor library provides $26 AHT cost per incident, which is realistic for a blended IT agent rate derived from $89K loaded salary. We pair this with the new "Annual Hours Handling Tickets" (30,000 H) driver instead of the old "9K tickets" count. The improvement is dialed to 12% — achievable through ITSM workflow automation (auto-routing reduces triage time), standardized Service Catalog templates (eliminates per-request configuration), and Knowledge base articles (reduces agent research). This replaces old benefits #4 and #5 which had aggressive 50%/80% improvement assumptions.',
    ...
    factors: [
      ...
      { name: '% reduction in ticket handling hours through workflow automation', type: 'improvement', source: 'new', sourceNote: 'Conservative estimate — blends workflow automation + KB articles + Service Catalog templates', value: '12%', y1: '12%', y2: '12%', y3: '12%' },
  ...
  },
  {
    ...
    factors: [
      ...
      { name: '% of downtime hours recovered through ITSM improvements', type: 'improvement', source: 'new', sourceNote: 'Conservative — 5% of measured downtime recovered via faster routing, SLA enforcement + self-service portal', value: '5%', y1: '5%', y2: '5%', y3: '5%' },
      { name: 'IT hourly rate', type: 'financial', source: 'current', sourceNote: 'New factor library', value: '$52', y1: '$52', y2: '$52', y3: '$52' },
      { name: 'Benefit Ramp', type: 'ramp', source: 'current', sourceNote: 'Standard ramp', value: '60/100/100%', y1: '60%', y2: '100%', y3: '100%' },
    ],
  ...
  },
  {
    ...
    rationale: 'Old benefits #3 and #5 used high improvement % (80%) against small drivers (360 hours, 1,100 requests). The new factor library provides "Annual Hours Handling Tickets" (30,000 H) — a much larger, realistic base. We apply 8% self-service deflection — well below vendor claims of 30% but realistic for year-1 adoption. Ivanti\'s Service Catalog (standardized request templates), Knowledge module (searchable self-help), and automated fulfillment workflows are the core ITSM features that enable deflection without AI add-ons.',
    ...
    factors: [
      { name: 'Annual Hours Handling Tickets', type: 'driver', source: 'current', sourceNote: 'New factor library', value: '30,000 H', y1: '30,000', y2: '30,000', y3: '30,000' },
      { name: '% of handling hours deflected through self-service', type: 'improvement', source: 'new', sourceNote: 'Conservative — 8% vs industry 30% claims. Reflects realistic year-1 self-service adoption via portal + KB', value: '8%', y1: '8%', y2: '8%', y3: '8%' },
      { name: 'IT hourly rate', type: 'financial', source: 'current', sourceNote: 'New factor library', value: '$52', y1: '$52', y2: '$52', y3: '$52' },
      { name: 'Benefit Ramp', type: 'ramp', source: 'current', sourceNote: 'Standard ramp', value: '60/100/100%', y1: '60%', y2: '100%', y3: '100%' },
    ],
